use crate::aetolia::classes::{Class, VenomPlan};
use crate::aetolia::curatives::first_aid::{parse_priority_set, FirstAidPriorities};
use crate::aetolia::types::{FType, Hypnosis};
use crate::topper::{TopperCore, TopperMessage, TopperModule, TopperRequest, TopperResponse};
...
impl DatabaseModule {
    ...
    pub fn insert_json<T: Serialize>(&self, tree: &str, key: &String, value: T) {
    ...
    pub fn get_json<T: DeserializeOwned>(&self, tree: &str, key: &String) -> Option<T> {
        self.get(tree, key)
            .and_then(|ivec| {
...
impl DatabaseModule {
    ...
    pub fn get_first_aid_priorities(
        &self,
        who: &String,
